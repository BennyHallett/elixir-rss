defmodule RSSTest do
  ...
  test "build feed with an escaped character" do
    ...
    item2 = RSS.Item.new title: "Post 2", description: "The second post", pub_date: "Mon, 12 Sep 2005 18:37:00 GMT", link: "https://test.blog/two", guid: "https://test.blog/two"
    channel = RSS.Channel.new title: "Test blog", link: "https://test.blog", description: "This is a test blog & it's good", last_build_date: "Mon, 12 Sep 2005 18:37:00 GMT", language: "en-us"
...
<rss version="2.0">
\t<channel>
\t\t<description>This is a test blog &amp; it's good</description>
